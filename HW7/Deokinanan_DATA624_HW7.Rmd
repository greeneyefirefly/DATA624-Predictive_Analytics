...
From the partial least squared model, the number of components which resulted in the smallest root mean squared error is 2. It has RMSE = 10.88, $R^2$ = 0.57, and MAE = 8.06. While it does account for the largest portion of the variability in the data than all other latent variables, it does not produce the smallest error. The number of components that produces the smallest error is 5, with RMSE = 10.40, $R^2$ = 0.56, and MAE = 8.14. 
